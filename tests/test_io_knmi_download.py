...
from acequia.io import KnmiDownload
from acequia.io import get_knmi_evaporation, get_knmi_precipitation
from acequia.io import get_knmi_weatherstations, get_knmi_precstations
...
def test_get_station_code():
    ...
    assert isinstance(code, np.int64)
