...
def get_waterweb_from_csv(fpath, name=None):
    """Read Waterweb csv file with level data.
    
    Parameters
    ----------
    fpath : str
        Filepath to WaterWeb csv export.
    name : str, optional
        Name of WaterWeb network.

    Returns
    -------
    WaterWeb instance
        Measured levels and technical data for WaterWeb network.
        
    """
    return WaterWeb.from_csv(fpath, network=name)
...
class WaterWeb:
    ...
    EXPECTED_COLUMNS = ['seriesname', 'gmwcode', 'sunseries', 
        ...
        'conductance', 'peilcode', 'typemeting', 'status', 'peilopm',
        ]
