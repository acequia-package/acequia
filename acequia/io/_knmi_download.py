...
from ..data import knmi_weatherstations
from ..data import knmi_raingauches
from ..tools import CrdCon, convert_WGS84toRD
...
class KnmiDownload:
    ...
    def __init__(self):
        ...
        #self._precstns = knmi_raingauches(geo=True)
        #self._weatherstations = knmi_weatherstations(geo=True)
        pass
    ...
    def get_weather_stations(self, geo=False):
        ...
        """
        return knmi_weatherstations(geo=geo)

        """
        stns = self._weatherstations
    ...
    def get_precipitation_stations(self, geo=False):
        ...
        """
        return knmi_raingauches(geo=geo)
    ...
    def _wtrstn_knmidownload(self):
        ...
        #if self._weatherstations is not None: # stations were downloaded earlier
        #    return self._weatherstations
