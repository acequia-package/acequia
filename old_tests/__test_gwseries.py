...
if __name__ == '__main__':
    ...
    if 1: 
        ...
        gw_dino = GwSeries.from_dinogws(filepath)
        print('Result: ',gw_dino)
    ...
    if 1:
        ...
        gw_json = GwSeries.from_json(filepath)
        print('Result: ',gw_json)
    ...
    if 1: 
        ...
        filepath = dinogwstestfilepath
        gw_json2 = GwSeries.from_dinogws(filepath)
        jdict = gw_json2.to_json(jsonoutdir)
    ...
    if 1: 
        ...
        filepath = dinogwstestfilepath
        gw_dino2 = GwSeries.from_dinogws(filepath)
        series = gw_dino2.to_csv(csvoutdir)
